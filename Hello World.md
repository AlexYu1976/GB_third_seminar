...
1.git init-инициализация локально репозитория.

2.git status-получить информацию от git о его текущем состоянии.

3.git add-добавить файл или файлы к следующему коммиту.

4.git commit --m "messadge"-создание коммита.
...
8.git diff-увидеть разницу между текщим файлом и закоммиченным файлом.
